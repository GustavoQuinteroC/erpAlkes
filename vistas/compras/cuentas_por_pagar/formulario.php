...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary">
                                ...
                                <div class="col-12">
                                    <div class="card mb-4">
                                        <div class="card-header text-bg-<?= getEnfasis(); ?>">
                                            <h3 class="card-title">Información de la Cuenta Por Pagar</h3>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <label for="idsocio"
                                                            class="col-sm-4 col-form-label text-start">Proovedor</label>
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <span class="input-group-text"><i
                                                                ...
                                                                <select id="idsocio" name="idsocio"
                                                                    ...
                                                                    onchange="JaxoncomprasCxp.cargarSocio({ seleccion: this.value });">
                                                                    <?php echo getProveedores(); ?>
                                                                </select>
                                                                <button class="btn btn-outline-secondary" type="button"
                                                                    id="botonBuscarSocio" name="botonBuscarSocio"
                                                                    title="Buscar socio"
                                                                    onclick="JaxoncomprasCxp.modalSeleccionarSocio();">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <select id="idsubcuenta" name="idsubcuenta"
                                                                    class="form-select select2-field"
                                                                    onchange="JaxoncomprasCxp.cargarSubcuenta({ seleccion: this.value }, document.getElementById('idsocio').value);">
                                                                </select>
                                                                <button class="btn btn-outline-secondary" type="button"
                                                                    id="botonBuscarSubcuenta"
                                                                    name="botonBuscarSubcuenta" title="Buscar subcuenta"
                                                                    onclick="JaxoncomprasCxp.modalSeleccionarSubcuenta(document.getElementById('idsocio').value);">
                                                                    <i class="bi bi-search"></i>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <select id="idconcepto" name="idconcepto"
                                                                    class="form-select select2-field">
                                                                    <?php echo getConceptosCuentas('Cargo', 'CXP'); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-header text-bg-<?= getEnfasis(); ?>">
                                            ...
                                            <div class="card-tools d-flex align-items-center gap-2">
                                                <button tabindex="400" id="addPartidas" name="addPartidas"
                                                    ...
                                                    onclick="JaxoncomprasCxp.modalAgregarAbono(jaxon.getFormValues('formulario<?= $_GET['rand'] ?>'));"
                                                    type="button">
    ...
    <?= scriptsHtml(); ?>
    <script>
        JaxoncomprasCxp.inializarFormulario();
    </script>
    <script>
