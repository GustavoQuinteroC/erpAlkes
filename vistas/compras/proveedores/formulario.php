...
<body class="layout-fixed-complete sidebar-expand-lg bg-body-tertiary">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <select id="idc_regimen" name="idc_regimen"
                                                                    onchange="JaxoncomprasProveedores.cambiarUsoCfdi(this.value);"
                                                                    class="form-select select2-field">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Código Postal" onchange="JaxoncomprasProveedores.ajustesCodigoPostal(this.value);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <!-- Monto de crédito -->
                                                    <div class="form-group row mb-3">
                                                        <label for="credito_monto_proveedor"
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="credito_monto_proveedor"
                                                                    name="credito_monto_proveedor"
                                                ...
                                                <div class="col-md-6">
                                                    <!-- Días de crédito -->
                                                    <div class="form-group row mb-3">
                                                        <label for="credito_dias_proveedor"
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    id="credito_dias_proveedor"
                                                                    name="credito_dias_proveedor"
    ...
    <?= scriptsHtml(); ?>
    <script>
        JaxoncomprasProveedores.inializarFormulario();
    </script>
</body>
